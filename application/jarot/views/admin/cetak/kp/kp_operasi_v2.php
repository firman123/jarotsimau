...
$this->fpdf->Image(base_url() . 'aset/img/kp_operasi.jpg', 0, 0, 8.6, 5.5, 'JPG');
...
$this->fpdf->Cell(2, 0.5, $datpil->kp_ijin_operasi, 0, 'L', 'L');
$this->fpdf->Ln();
$this->fpdf->SetFont('Arial', 'B', 14);
$this->fpdf->Cell(5.5, 2, '', 0, 'L', 'R');
$this->fpdf->Image(base_url() . 'qr.png', 6.3, 3.2, 2, 2, 'PNG');
// $this->fpdf->Line(1,3.5,30,3.5);
$this->fpdf->Output("kartu Pengawasan Operasi.pdf", "I");
?>