    ...
    <div class="row-fluid well" style="overflow: hidden">
        ...
        <div class="col-lg-6">
            <table  class="table-form">
                ...
                <tr><td width="20%">Id. Kendaraan</td><td><b><input type="text" name="id_kendaraan" required value="<?php echo $id_kendaraan; ?>" id="kendaraan" style="width: 300px" class="form-control" placeholder="Bersarkan no kendaraan (numeric)"></b></td></tr>		
