...
class Pemeriksaan extends CI_Controller {
    ...
    public function index_trayek() {
        $total_row = $this->m_pemeriksaan->get_total_pemeriksaan("trayek");
        $per_page = 10;
        ...
        $a['data'] = $this->m_pemeriksaan->get_pemeriksaan_all("trayek", $akhir, $awal);
    ...
    public function index_operasi() {
        $total_row = $this->m_pemeriksaan->get_total_pemeriksaan("operasi");
        $per_page = 10;
        ...
        $a['path'] = "operasi";
        $a['sub_title'] = 'Angkutan Barang';
        $a['data'] = $this->m_pemeriksaan->get_pemeriksaan_all("operasi", $akhir, $awal);
        $a['page'] = "pemeriksaan/list";
    ...
    public function input_checklist($jenis) {
        $total_row = $this->m_pemeriksaan->get_total_checklist_pemeriksaan($jenis);
        $per_page = 10;
        ...
        $a['data'] = $this->m_pemeriksaan->get_checklist_pemeriksaan($jenis, $akhir, $awal);
