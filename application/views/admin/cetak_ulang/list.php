...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		?>
			...
			<td class="ctr">
				<div class="btn-group">
                                    <a href="<?php echo base_URL()?>index.php/cetak_ulang/act_delete/<?php echo $b->id_cetak_ulang; ?>" class="btn btn-warning btn-sm" title="Hapus Data" onclick="return confirm('Anda Yakin..?')"><i class="icon-trash icon-remove">  </i> Del</a>	
                               	</div>	
