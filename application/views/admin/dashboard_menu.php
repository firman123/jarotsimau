...
<!--                    <a href="<?php echo site_url('pemeriksaan/index') ?>" class="tile bg-magenta fg-white" data-role="tile">
    <div class="tile-content">
       <div style="width: 100%; height: 100%; line-height: 50px; padding: 10px; text-align: center; margin-top: 40px;"><h4>Pemeriksaan</h4></div>
    </div>
</a>-->
                ...
                <div class="tile-container">
                    ...
                    <?php } ?>
                        ...
                        <a href="<?php echo site_url('verifikasi_barang') ?>" class="tile fg-white" data-role="tile">
                            <!--<div class="tile-wide" data-role="tile" data-effect="slideLeft">-->
                            <div class="tile-content bg-green">
                                <h4 style="text-align: center; margin-top: 50px;">Verifikasi 2 <br/> ( Barang ) </h4>
                            </div>
                        </a>
                    <?php } ?>
                    
                         <?php if ($data_user['kendaraan'] == 1) { ?>
                        <a href="<?php echo site_url('cetak_ulang') ?>" class="tile-wide fg-white" data-role="tile">
                            <!--<div class="tile-wide" data-role="tile" data-effect="slideLeft">-->
                            <div class="tile-content bg-orange">
                                <h2 style="text-align: center; margin-top: 50px;">Rusak / Hilang</h2>
                            </div>
                        </a>
                    <?php } ?>
                       <?php if ($data_user['rubah_sifat'] == 1) { ?>
