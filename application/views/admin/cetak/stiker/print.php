...
<!--            <table style="height: 50%;">
                <tr style="border-left: 0px; border-right: 0px;">
                    ...
                    <td rowspan="2" style="width: 60%; vertical-align: bottom;">
                        <div class="text_terbalik font_setting text_padding">Kode Trayek : <?php echo $datpil->kd_trayek; ?></div>
                    </td>
                </tr>
                <tr>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <div class="text_terbalik font_setting text_padding" style=" vertical-align: bottom; height: 100%;">Nomor Kartu Pengawasan : <?php echo $datpil->kp_ijin_trayek; ?></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div style="width: 100%; height: 70%; vertical-align: bottom;">
                            ...
                            <div style="width: 70%; height: 100%; float: left;">     
                                <table style="height: 100%; border: 0px;">
                                    <tr style="border: 0px;">
                                        <td class=" font_header text_terbalik" style="height: 50%; border: 0px; vertical-align: top;">Kartu Pengewasan Izin Trayek</td>
                                    </tr>
                                    <tr style="border: 0px;">
