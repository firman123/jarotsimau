<html>
    <head>
        <style type="text/css" media="print">
            #kotak {
                background: url(<?php echo base_url(); ?>aset/img/kp_operasi.jpg) no-repeat;
                width: 329px;
                border: solid 1px;
            }
    ...
    <body onload="window.print()">
        <div id="kotak">
            <table style="margin-top: 5px;">
                ...
                <tr>
                    ...
                    <td style="padding-top: 2px; float: right;  margin-right: 5px;">
                        <div id="title"><b>
                                <?php
                                if ($path == 'trayek')
                                    echo $datpil->kp_ijin_trayek;
                                else
                                    echo $datpil->kp_ijin_operasi;
                                ?>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        <div id="title" style="font-size: 20px; float: right;"></div>
                    </td>
