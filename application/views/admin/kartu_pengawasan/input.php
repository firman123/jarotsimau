    ...
    <div class="row-fluid well" style="overflow: hidden">
        ...
        <div class="col-lg-6">
            <table  class="table-form">
                ...
                <tr><td style="width: 50%;">Pilih No. Kendaraan</td><td style="width: 50%;"><b><input type="text" name="no_kendaraan" required value="<?php echo $no_kendaraan; ?>" id="kendaraan_advance" style="width: 300px" class="form-control" placeholder="Ketik simau"/></b></td></tr>
