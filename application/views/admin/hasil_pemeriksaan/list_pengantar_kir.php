            ...
            <div class="navbar navbar-inverse">
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">Verifikasi Pengantar Kir</a>
                    </div>
...
//                    print_r($b);
                ...
                <td class="ctr">
                    <div class="btn-group">	
                        ...
                        <a href="<?php echo base_URL() ?>index.php/hasil_pemeriksaan/view_pengantar_kir/<?php echo $b->id_pengantar; ?>" class="btn btn-success btn-sm" title="Edit Data"><i class="icon-edit icon-white"> </i> Verifikasi</a>
                    </div>	
    ...
    <center><ul class="pagination"><?php echo $pagi_kir; ?></ul></center>
</div>
