...
class master_data extends CI_Controller {
    ...
    public function kendaraan() {
        ...
        /* pagination */
        $total_row = $this->db->query("SELECT * FROM tbl_kendaraan ORDER BY id_kendaraan DESC")->num_rows();
        $per_page = 10;
...
//            $a['datpil'] = $this->db->query("SELECT * FROM tbl_kendaraan WHERE no_uji = '$idu'")->row();
            ...
            $a['data'] = $this->db->query("SELECT * FROM tbl_kendaraan ORDER BY id_kendaraan DESC LIMIT $akhir OFFSET $awal ")->result();
            $a['page'] = "kendaraan/list";
        }
