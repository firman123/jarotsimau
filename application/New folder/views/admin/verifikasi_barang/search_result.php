<div class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header">
            <span class="navbar-brand" href="#">Daftar Verifikasi Peremajaan</span>
        </div>
    </div><!-- /.container -->
</div><!-- /.navbar -->
...
<div class="row-fluid well" style="overflow: hidden">
    ...
    <div class="col-lg-6">
        <table  class="table-form">
            ...
            <form action="<?php echo site_url("verifikasi_barang/konfirmasi"); ?>" method="post" accept-charset="utf-8">
                <input type="hidden" name="id_peremajaan" value="<?php echo $kendaraan['id_peremajaan'];?>" />
                ...
                <tr><td width="20%">Nomor Kendaraan Lama</td><td><b><input type="text" readonly="true" name="no_kendaraan_lama" required value="<?php echo $kendaraan['no_kendaraan']; ?>" id="masa_berlaku" style="width: 300px" class="form-control" readonly /></td></tr>	
                <tr><td width="20%">Nomor Kendaraan Baru</td><td><b><input type="text" readonly="true" name="no_kendaraan_baru" required value="<?php echo $kendaraan['no_kendaraan_baru']?>" id="masa_berlaku" style="width: 300px" class="form-control" /></td></tr>	
