                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse navbar-inverse-collapse" style="margin-right: -20px">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <form class="navbar-form navbar-left" method="post" action="<?php echo site_url('hasil_pemeriksaan/cari_kendaraan_by_tanggal'); ?>">
        ...
        <tbody>
            ...
            if (empty($data)) {
               ...
               <td><?php echo $b->kd_trayek; ?></td>
                ...
                <td class="ctr">
                    <div class="btn-group">
                        <a href="<?php echo base_URL() ?>index.php/hasil_pemeriksaan/view_print_<?php echo $path; ?>/<?php echo $b->id_checklist; ?>" class="btn btn-info btn-sm" <?php if($b->status_verifikasi==1) { echo 'enabled'; } else { echo 'disabled'; } ?>><i class="icon-print icon-white">  </i> Print</a>	
