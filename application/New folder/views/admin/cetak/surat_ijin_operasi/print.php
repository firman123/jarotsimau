...
$this->fpdf->MultiCell(1, 1, 'NO', 1, 'C');
$this->fpdf->SetXY(2.3,4);
$this->fpdf->MultiCell(3, 0.5, 'NO KENDARAAN', 1, 'C');
$this->fpdf->SetXY(5.3,4);
$this->fpdf->MultiCell(3, 0.5, 'MERK KENDARAAN', 1, 'C');
$this->fpdf->SetXY(8.3,4);
$this->fpdf->MultiCell(3, 0.5, 'TAHUN PEMBUATAN', 1, 'C');
$this->fpdf->SetXY(11.3,4);
$this->fpdf->MultiCell(3, 1, 'JENIS', 1, 'C');
$this->fpdf->SetXY(14.3,4);
$this->fpdf->MultiCell(2.5, 0.5, 'DAYA ANGKUT', 1, 'C');
$this->fpdf->SetXY(16.8,4);
$this->fpdf->MultiCell(3, 1, 'KETERANGAN', 1, 'C');
$nomor = 0;
foreach ($data_kendaraan as $item) {
  $nomor++;
  $this->fpdf->Cell(0.3, 0.5,'', 0, 0, 'C');
  $this->fpdf->Cell(1, 0.5, $nomor, 1, 0, 'C');
  $this->fpdf->Cell(3, 0.5, $item->no_kendaraan, 1, 0, 'C');
   $this->fpdf->Cell(3, 0.5, $item->merk, 1, 0, 'C');
  $this->fpdf->Cell(3, 0.5, $item->tahun, 1,0, 'C');
  $this->fpdf->Cell(3, 0.5, $item->jenis, 1, 0,'C');
  $this->fpdf->Cell(2.5, 0.5, '', 1, 0, 'C');
  $this->fpdf->Cell(3, 0.5, '', 1, 1, 'C');
}
