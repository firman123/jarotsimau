    ...
    <div class="row-fluid well" style="overflow: hidden">
        ...
        <div class="col-lg-6">
            <table  class="table-form">
                ...
                <tr><td width="20%">No. Kendaraan</td><td><b><input type="text" <?php if($mode=='edt') echo 'readonly=""'; ?>  name="no_kendaraan" required value="<?php echo $no_kendaraan; ?>" id="dari" style="width: 400px" class="form-control"></b></td></tr>		
        ...
        <div class="col-lg-6">	
            <table  class="table-form">
                <tr><td>No. Rangka</td><td><b><input type="text" name="no_chasis" <?php if($mode=='edt') echo 'readonly=""'; ?> required value="<?php echo $no_chasis; ?>" style="width: 300px" class="form-control"></b></td></tr>
                <tr><td width="20%">Nomor Mesin</td><td><b><input type="text" name="no_mesin" <?php if($mode=='edt') echo 'readonly=""'; ?> id="kode_surat" required value="<?php echo $no_mesin; ?>" style="width: 300px" class="form-control"></b></td></tr>
                <tr><td>Sifat</td><td><b>                                
