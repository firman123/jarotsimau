	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse navbar-inverse-collapse" style="margin-right: -20px">
			...
			<ul class="nav navbar-nav navbar-right">
                            <form class="navbar-form navbar-left" method="post" action="<?php echo site_url('pemeriksaan/cari_kendaraan_by_tanggal'); ?>">
                                <input type="hidden" name="path" value="<?php echo $path; ?>" />	
                                <input type="text" class="form-control" name="tanggal" style="width: 200px" placeholder="Tanggal" id="tanggal_report" required>
...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		?>
			...
			<td class="ctr">
				<div class="btn-group">
                                    <a href="<?php echo base_URL()?>index.php/pemeriksaan/act_delete_<?php echo $path; ?>/<?php echo $b->id_pemeriksaan; ?>/<?php echo $b->kendaraan_id; ?>" class="btn btn-warning btn-sm" title="Hapus Data" onclick="return confirm('Anda Yakin..?')"><i class="icon-trash icon-remove">  </i> Del</a>	
                               	</div>	
